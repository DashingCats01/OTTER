...
//    _shaders[index]->LoadShaderPartFromFile("shaders/Post/guassian_blur.glsl", GL_FRAGMENT_SHADER);
    _shaders[index]->LoadShaderPartFromFile("shaders/Post/bloomBrightness.glsl", GL_FRAGMENT_SHADER);
